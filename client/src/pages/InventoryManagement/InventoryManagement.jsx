  ...
  const generateReport = () => {
    ...
    fetch("http://localhost:3000/api/inventory/read")
      ...
      .then((data) => {
        ...
        doc.setFontSize(20);
        doc.setTextColor(0, 0, 255);
        doc.text("MedLink (PVT) LTD", margin, yPos);
        doc.setTextColor(0);
      ...
      <div className="flex-1">
        <div className="bg-paleblue justify-between flex px-10 py-10">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-white hover:bg-light-blue hover:text-white text-black border-2 border-light-blue font-semibold transition-all py-1 px-3 rounded-lg inline-flex items-center"
            >
            ...
            <div className="flex gap-2 cursor-pointer">
              <img
                ...
                src="https://avatars.githubusercontent.com/u/127751216?…00&u=f53b685eb62a23a72baeda2f44a671c04b804c86&v=4"
                alt="profile"
              />
        ...
        <div className="flex gap-2 justify-between px-10 text-sm pt-2">
          <span className="text-2xl font-semibold">
            All Inventory Items ({inventorycount})
          </span>
